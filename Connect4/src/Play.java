...
/**this is the main board where the game is played. JFrame is created as soon as user clicks either "Player vs Player" button or "Computer button".
 * @author Aryan, Adarsh 
 */
...
public class Play extends JFrame {
	 ...
	 * 
	 * @param type - boolean type of which of the button "P vs P" or "computer" was
	 *             selected. If it was true, the it is player vs player, else its
	 *             player vs computer
	 */
	 ...
	 */
	public static void putAtBottom(int column, int player) {
